...
def L1(word_num):
    ...
    l1_model = tf.keras.Sequential([
        tf.keras.layers.Dense(1024, activation = 'relu', kernel_regularizer = tf.keras.regularizers.l1(0.001), input_shape=(word_num,)), 
        ...
        tf.keras.layers.Dense(8, activation = 'relu',  kernel_regularizer = tf.keras.regularizers.l1(0.001)),
        tf.keras.layers.Dense(1, activation= 'sigmoid')
    ])
...
def L2(word_num):
    ...
    l2_model = tf.keras.Sequential([
        tf.keras.layers.Dense(1024, activation = 'relu', kernel_regularizer = tf.keras.regularizers.l2(0.001), input_shape=(word_num,)), 
...
def main():
    ...
    print('\n')
    l1_history = l1_model.fit(train_data, train_labels, epochs = 10, batch_size=128, verbose=0, validation_data=(test_data, test_labels))
    print('\n')
    l2_history = l2_model.fit(train_data, train_labels, epochs = 10, batch_size=128, verbose=0, validation_data=(test_data, test_labels))
